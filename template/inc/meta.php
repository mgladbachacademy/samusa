...
?>
  ...
  <link rel="preload" href="https://samusaconsultant.id/template/img/blog/<?php echo htmlspecialchars($article['hero_image']); ?>-mobile-small.jpg" as="image" type="image/jpg">
<?php } ?>
...
<style><?php require ($_SERVER['SMS'].'template/css/font.css')?></style>
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.7.1/jquery.min.js"></script>
<script>window.jQuery || document.write('<script src="template/js/jquery.js"><\/script>');</script>
<script async>
